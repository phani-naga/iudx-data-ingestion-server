...
public interface DataBrokerService {
  ...
  /**
   * The ingestDataPost implements the registration of adaptor functionality with the data broker.
   *
  ...
  /**
   * The ingestDataDelete implements the deletion of exchange broker.
   *
   * @param request which is a JsonObject
   * @param handler which is a Request Handler
   * @return DataBrokerService which is a Service
  ...
  /**
   * The publishData implements the publishing data functionality with the data broker.
   *
   * @param request which is a JsonObject
   * @param handler which is a Request Handler
   * @return DataBrokerService which is a Service
